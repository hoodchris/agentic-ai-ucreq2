...
| B3-6  | The protocol is required to define an agent identifier format that is globally unique and resolvable to the agent's endpoint using an appropriate discovery mechanism. | Discovery |
