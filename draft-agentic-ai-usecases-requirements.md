...
individual message exchanges and network connections. A session MAY carry
and maintain one or more contexts shared between agents.

**Task**: A unit of work submitted by a user or generated by an agent,
and possibly delegated between agents, for execution. A task is identified
