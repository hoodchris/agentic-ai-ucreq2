...
| B3-6  | The protocol is required to define an agent identifier format that uniquely represents an agent identity and can be resolved, directly or indirectly, to the agent’s communication endpoint using an appropriate discovery mechanism. | Discovery |
